...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { acceso: @area.acceso, area: @area.area, proyecto_id: @area.proyecto_id } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { acceso: @area.acceso, area: @area.area, proyecto_id: @area.proyecto_id } }
