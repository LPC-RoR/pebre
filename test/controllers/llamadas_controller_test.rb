...
class LlamadasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create llamada" do
    assert_difference('Llamada.count') do
      post llamadas_url, params: { llamada: { anombre: @llamada.anombre, anulada: @llamada.anulada, contacto: @llamada.contacto, hora: @llamada.hora, paxs: @llamada.paxs } }
    end
  ...
  test "should update llamada" do
    patch llamada_url(@llamada), params: { llamada: { anombre: @llamada.anombre, anulada: @llamada.anulada, contacto: @llamada.contacto, hora: @llamada.hora, paxs: @llamada.paxs } }
