...
class GruposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post grupos_url, params: { grupo: { activo: @grupo.activo, grupo: @grupo.grupo, orden: @grupo.orden } }
    end
  ...
  test "should update grupo" do
    patch grupo_url(@grupo), params: { grupo: { activo: @grupo.activo, grupo: @grupo.grupo, orden: @grupo.orden } }
