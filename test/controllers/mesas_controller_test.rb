...
class MesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post mesas_url, params: { mesa: { mesa: @mesa.mesa, pasajeros: @mesa.pasajeros, reserva: @mesa.reserva, zona: @mesa.zona } }
    end
  ...
  test "should update mesa" do
    patch mesa_url(@mesa), params: { mesa: { mesa: @mesa.mesa, pasajeros: @mesa.pasajeros, reserva: @mesa.reserva, zona: @mesa.zona } }
