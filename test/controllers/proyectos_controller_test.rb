...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { direccion: @proyecto.direccion, proyecto: @proyecto.proyecto, razon_social: @proyecto.razon_social, rut: @proyecto.rut } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { direccion: @proyecto.direccion, proyecto: @proyecto.proyecto, razon_social: @proyecto.razon_social, rut: @proyecto.rut } }
